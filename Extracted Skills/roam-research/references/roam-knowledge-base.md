...
- **Tables**: `/table` command; rows and columns as indented children
...
### Notable Extensions (as of April 2026)
...
|------------|-----------|
| No native mobile app | Install as webapp via Chrome (Add to Homescreen) |
